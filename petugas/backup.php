      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header">Input Data :</h6>
            ...
            <a class="collapse-item active" href="backup.php">Backup Data</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h2 mb-0 text-gray-800">Backup Data</h1>
            <a href="#" data-target="#backupModal" data-toggle="modal" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Backup Data</a>
          </div>
        </div>
        <!-- /.container-fluid -->
