      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container">
            ...
            <center>
              <h3>Panduan penggunaan sistem RTLH campurejo</h3><br>
            </center>

            <strong>Beranda</strong>
            <p>Didalam menu beranda terdapat rekap data yang telah di input kesalam sistem,
            rekap yang ada pada menu ini ada yang berupa diagram grafik, diagram pie dan total jumlah
            ...
            <ul class="list-unstyled">
              ...
              <li><strong>View Data</strong></li>Hasil dari pada form input akan masuk kedalam menu ini. 
              <li><strong>Penilaian & Edit</strong></li>Menu ini terdapat rekap dari hasil input, dan sudah di beri sistem penilaian, jadi pada menu ini yang layak dan tidak layak untuk mendapatkan bantuan akan terlihat.
              <li><strong>Backup Data</strong></li>Penyalinan data perlu dilakukan dalam sebuah siste, dan menu backup ini adalah tempat penyalinan data itu.
            </ul>
