	...
	<body id="page-top">
		...
		header("Content-Disposition: attachment; filename=Data Score Surve.xls");
		?>
			...
			<table table rules="all" style="border: 1px black;">
				<thead>
					<tr>
						...
						<th style="text-align:center">Sumber Listrik</th>
				...
				<tbody>
					<?php
					include '../koneksi.php';
					$query = "SELECT * FROM tabel_identitas_responden_score
								JOIN tabel_aspek_score ON tabel_aspek_score.nik_aspek = tabel_identitas_responden_score.nik_responden"; 
